...
import { getWarehouses, getStock } from '../../services/api';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4 text-sm text-[#8D6E63]">
        ...
        <span className="truncate">{warehouse.address || 'No address'}</span>
      </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
    <div className="bg-white rounded-lg border border-[#D7CCC8] p-4 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xl font-bold text-[#3E2723]">{warehouses.length}</p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-lg border border-[#D7CCC8] p-4 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xl font-bold text-[#3E2723]">{totalStock.toLocaleString()}</p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-lg border border-[#D7CCC8] p-4 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs text-[#8D6E63] font-medium">Avg Stock/Warehouse</p>
          <p className="text-xl font-bold text-[#3E2723]">
            {warehouses.length > 0 ? Math.round(totalStock / warehouses.length).toLocaleString() : 0}
          </p>
        </div>
      </div>
    </div>
...
const WarehouseListPage = () => {
  ...
  const totalStock = stock.reduce((sum, item) => sum + item.on_hand, 0);
    ...
    <div className="w-full min-h-[calc(100vh-64px)] bg-[#FBF8F4] pt-16">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {!loading && warehouses.length > 0 && (
          <StatsSummary warehouses={warehousesWithStock} totalStock={totalStock} />
        )}
